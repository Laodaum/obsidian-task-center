...
const EN = {
  ...
  "tab.dropped": "Dropped",
  "tab.horizon": "Horizon",
  "horizon.bucket.today": "Today",
  "horizon.bucket.this-week": "This Week",
  "horizon.bucket.next-week": "Next Week",
  "horizon.bucket.this-month": "This Month",
  "horizon.empty": "No tasks",
  ...
  "settings.defaultView.horizon": "Horizon",
...
const ZH: Partial<typeof EN> = {
  ...
  "tab.dropped": "已放弃",
  "tab.horizon": "视界",
  "horizon.bucket.today": "今天",
  "horizon.bucket.this-week": "本周",
  "horizon.bucket.next-week": "下周",
  "horizon.bucket.this-month": "本月",
  "horizon.empty": "无任务",
  ...
  "settings.defaultView.horizon": "视界",
